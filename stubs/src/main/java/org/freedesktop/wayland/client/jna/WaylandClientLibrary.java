...
public interface WaylandClientLibrary extends WaylandUtilLibrary {
  ...
  public static final WaylandClientLibrary INSTANCE = (WaylandClientLibrary) Native
      .loadLibrary(WaylandClientLibrary.JNA_LIBRARY_NAME, WaylandClientLibrary.class);
  ...
  wl_proxy wl_proxy_marshal_array_constructor(wl_proxy proxy, int opcode,
                                              wl_argument args,
                                              wl_interface interface$);
  ...
  void wl_proxy_set_user_data(wl_proxy proxy, Pointer user_data);
